    ...
    val statsWithReforge: ItemData
        get() {
            return ItemData(
                ...
                defense = itemData.defense + (itemData.reforge.defense[itemData.rarity] ?: 0).toBigInteger(),
                health = itemData.health + (itemData.reforge.health[itemData.rarity] ?: 0).toBigInteger(),
                damage = itemData.damage + (itemData.reforge.damage[itemData.rarity] ?: 0).toBigInteger(),
                strength = itemData.strength + (itemData.reforge.strength[itemData.rarity] ?: 0).toBigInteger(),
                critDamage = itemData.critDamage + (itemData.reforge.critDamage[itemData.rarity] ?: 0).toBigInteger(),
                critChance = itemData.critChance + (itemData.reforge.critChance[itemData.rarity] ?: 0),
                intelligence = itemData.intelligence + (itemData.reforge.intelligence[itemData.rarity] ?: 0).toBigInteger(),
                speed = itemData.speed + (itemData.reforge.speed[itemData.rarity] ?: 0),
